...
export default function Hero() {
  ...
  // m and t are only true after client mount — safe for SSR
  const m = mounted && isMobile;
  const t = mounted && isTablet;
  ...
  return (
    <section id="home" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden", zIndex: 1 }}>

      {/* Floating particles — client only */}
      {mounted && !m && particles.map((p) => (
        <motion.div
          key={p.id}
      ...
      {/* Parallax blobs */}
      <motion.div style={{ x: blobX, y: blobY, position: "absolute", top: "15%", left: "-180px", width: 600, height: 600, borderRadius: "50%", background: "rgba(99,102,241,0.1)", filter: "blur(100px)", pointerEvents: "none" }} />
      <motion.div style={{ x: blobX, y: blobY, position: "absolute", bottom: "5%", right: "-120px", width: 500, height: 500, borderRadius: "50%", background: "rgba(192,132,252,0.08)", filter: "blur(100px)", pointerEvents: "none" }} />

      <div style={{
        position: "relative", zIndex: 2,
        maxWidth: 1100, margin: "0 auto",
        padding: m ? "100px 20px 60px" : t ? "110px 32px 70px" : "120px 32px 80px",
        width: "100%",
        display: "flex",
        flexDirection: m || t ? "column" : "row",
        ...
        {/* LEFT */}
        <div style={{ flex: "1 1 auto", maxWidth: m ? "100%" : 620 }}>

          {/* Status badge */}
          <motion.div
            initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
            style={{ display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 28, padding: "8px 16px", borderRadius: 999, border: "1px solid rgba(52,211,153,0.3)", background: "rgba(52,211,153,0.08)", color: "#6ee7b7", fontSize: 12, fontWeight: 600 }}
          >
            <span style={{ width: 7, height: 7, borderRadius: "50%", background: "#34d399", boxShadow: "0 0 10px #34d399", flexShrink: 0 }} />
          ...
          <motion.h1
            ...
            style={{ fontSize: "clamp(36px, 6vw, 76px)", fontWeight: 900, letterSpacing: "-0.03em", lineHeight: 1.04, color: "#fff", marginBottom: 18 }}
          >
            Hi, I&apos;m{" "}
          ...
          >
            <span style={{ fontSize: "clamp(16px, 2.5vw, 26px)", fontWeight: 600, color: "#c7d2fe" }} ref={roleRef} />
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.28 }}
            style={{ display: "flex", alignItems: "center", gap: 6, color: "#64748b", fontSize: 13, marginBottom: 24 }}
          >
          ...
          <motion.p
            ...
            style={{ color: "#94a3b8", fontSize: "clamp(15px, 1.8vw, 17px)", lineHeight: 1.75, maxWidth: 520, marginBottom: 36 }}
          >
          ...
          >
            <motion.a
              ...
              style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 28px", borderRadius: 14, background: "linear-gradient(135deg, #6366f1, #8b5cf6)", color: "#fff", fontWeight: 700, fontSize: 14, textDecoration: "none", boxShadow: "0 0 32px rgba(99,102,241,0.4), 0 4px 20px rgba(0,0,0,0.3)" }}
            >
              View My Work
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
            </motion.a>
            <motion.a
              href="/assets/GudduKumarResume.pdf" download
              whileHover={{ scale: 1.04, y: -2 }} whileTap={{ scale: 0.97 }}
              style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 28px", borderRadius: 14, border: "1px solid rgba(255,255,255,0.15)", background: "rgba(255,255,255,0.05)", color: "#cbd5e1", fontWeight: 700, fontSize: 14, textDecoration: "none", backdropFilter: "blur(8px)" }}
            >
        ...
        {!m && (
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1, width: t ? 200 : 260, height: t ? 200 : 260, borderRadius: "50%", border: "3px solid rgba(3,3,8,1)", background: "linear-gradient(135deg, rgba(99,102,241,0.2) 0%, rgba(139,92,246,0.15) 100%)", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", boxShadow: "0 0 60px rgba(99,102,241,0.25), inset 0 0 60px rgba(99,102,241,0.08)" }}>
              <span style={{ fontSize: t ? 60 : 80, fontWeight: 900, letterSpacing: "-0.04em", background: "linear-gradient(135deg, #818cf8, #c084fc)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", userSelect: "none" }}>GK</span>
            </div>
            <motion.div animate={{ y: [0, -8, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
              style={{ position: "absolute", bottom: -8, right: -28, display: "flex", alignItems: "center", gap: 8, padding: "10px 16px", borderRadius: 12, border: "1px solid rgba(52,211,153,0.2)", background: "rgba(10,10,25,0.95)", backdropFilter: "blur(16px)", fontSize: 12, fontWeight: 600, color: "#e2e8f0", boxShadow: "0 8px 32px rgba(0,0,0,0.4)", whiteSpace: "nowrap" }}
            >
            ...
            <motion.div animate={{ y: [0, 8, 0] }} transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
              style={{ position: "absolute", top: -8, left: -36, display: "flex", alignItems: "center", gap: 8, padding: "10px 16px", borderRadius: 12, border: "1px solid rgba(99,102,241,0.2)", background: "rgba(10,10,25,0.95)", backdropFilter: "blur(16px)", fontSize: 12, fontWeight: 600, color: "#e2e8f0", boxShadow: "0 8px 32px rgba(0,0,0,0.4)", whiteSpace: "nowrap" }}
            >
              🎓 B.Tech CSE
            </motion.div>
          </motion.div>
