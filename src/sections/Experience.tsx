      ...
      >
        ...
        <div
          style={{
            ...
            bottom: 8,
            width: 1,
            background: "linear-gradient(to bottom, rgba(99,102,241,0.8), rgba(99,102,241,0.2), transparent)",
          }}
        />
        ...
        {experiences.map((exp, i) => (
          <motion.div
            ...
            style={{ position: "relative", paddingLeft: 52, paddingBottom: 28 }}
          >
            {/* Dot */}
            <div
              style={{
            ...
            >
              <div
                style={{
                  ...
                  height: 10,
                  borderRadius: "50%",
                  background: exp.current ? "#34d399" : "#6366f1",
                }}
              />
            </div>
            ...
            >
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
                  <h3 style={{ color: "#fff", fontWeight: 700, fontSize: 18, lineHeight: 1.2 }}>
                    {exp.role}
                  </h3>
                  {exp.current && (
                    <span
                ...
                <span style={{ color: "#475569", fontSize: 12, fontFamily: "monospace", whiteSpace: "nowrap" }}>
                  {exp.duration}
                </span>
              </div>
